...
The cog can execute code stored in the general purpose space by pointing it's PC to the corresponding register address (`0x000 - `0x1cf`). PC can also point to `0x1d0` - `1ff`, but that isn't useful. 
