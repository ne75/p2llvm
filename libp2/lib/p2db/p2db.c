...
// by defining this as a non-zero value, the linker should use this value rather than the defualt, and then startup code
// will execute the debug setup code
volatile unsigned int __enable_p2db = 1;
